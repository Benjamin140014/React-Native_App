...
export default class Modals extends Component {
  ...
  applyAllInputPump1 = () => {
    this.postApi(
      'PLC2',
      'pmp5_TimeSet1h',
      this.state.timeHourPump5_1,
      'UInt16',
    );
    this.postApi(
      'PLC2',
      'pmp5_TimeSet1m',
      this.state.timeMinutePump5_1,
      'UInt16',
    );
    this.postApi(
      'PLC2',
      'pmp5_TimeSet2h',
      this.state.timeHourPump5_2,
      'UInt16',
    );
    this.postApi(
      'PLC2',
      'pmp5_TimeSet2m',
      this.state.timeMinutePump5_2,
      'UInt16',
    );
  ...
  componentDidMount() {
    ...
    this.socket.on('loadDataControl', data => {
      this.setState({readRPM5_1: data[29].value});

      // pump5_1

      if (data[30].value === true) {
        this.setState({TextStatusPump5_1: 'RUN'});
        this.setState({colorTextPump5_1: true});
        this.setState({
          imageStatusPump5_1: require('../../../image/Pump_048.png'),
        });
      ...
      this.setState({readRPM5_2: data[32].value});

      // pump5_2

      if (data[33].value === true) {
        this.setState({TextStatusPump5_2: 'RUN'});
        this.setState({colorTextPump5_2: true});
        this.setState({
          imageStatusPump5_2: require('../../../image/Pump_048.png'),
        });
      ...
      <View style={styles.pump5Panel}>
            ...
            <View style={styles.containerModal}>
              <View style={styles.columMainModal}>
                <View style={styles.pump1_1}>
                  <Image
                    source={this.state.imageStatusPump5_1}
                    style={styles.pump1_1}
                  />
                </View>
                <View style={styles.pump1_2}>
                  <Image
                    source={this.state.imageStatusPump5_2}
              ...
              <View style={styles.columMainModal}>
                <TouchableOpacity
                  style={[
                    ...
                    ,
                    {
                      backgroundColor: this.state.colorButtonManAutoPump5
                        ? 'blue'
                        : 'steelblue',
                    },
                  ]}
              ...
              <View style={styles.columMainModal}>
                <TouchableOpacity
                  style={[
                    styles.button1,
                    {
                      backgroundColor: this.state.colorButtonStartStopPump5_1
                        ? 'blue'
                        : 'steelblue',
                    },
                  ]}
                ...
                <TouchableOpacity
                  style={[
                    styles.button1,
                    {
                      backgroundColor: this.state.colorButtonStartStopPump5_2
                        ? 'blue'
                        : 'steelblue',
                    },
                  ]}
              ...
              <View style={styles.columInputModal}>
                <TextInput
                  ...
                  onChangeText={val => {
                    this.state.timeHourPump5_1 = val;
                  }}
                />
                ...
                <TextInput
                  ...
                  placeholderTextColor="#60605e"
                  onChangeText={val => {
                    this.state.timeMinutePump5_1 = val;
                  }}
                  keyboardType={'numeric'}
                />
                ...
                <TextInput
                  ...
                  placeholderTextColor="#60605e"
                  onChangeText={val => {
                    this.state.timeHourPump5_2 = val;
                  }}
                  keyboardType={'numeric'}
                />
                <Text style={{margin: 2}}>H</Text>
                ...
                <TextInput
                  ...
                  placeholderTextColor="#60605e"
                  onChangeText={val => {
                    this.state.timeMinutePump5_2 = val;
                  }}
                  keyboardType={'numeric'}
                />
                <Text style={{margin: 2}}>M</Text>
        ...
        <View style={styles.textPump}>
          <Text
            style={[
              styles.statusPump1,
              {color: this.state.colorTextPump5_1 ? 'green' : 'red'},
            ]}>
            {' '}
            {this.state.TextStatusPump5_1}{' '}
          </Text>
          <Text
            style={[
              styles.statusPump1,
              {color: this.state.colorTextPump5_2 ? 'green' : 'red'},
            ]}>
            {' '}
            {this.state.TextStatusPump5_2}{' '}
          </Text>
        </View>
